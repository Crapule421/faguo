    ...
    <div id="formulaire">
        <div id="inscription">
            <form action="newUser.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="lastname" type="text" class="form-control <?php if ($code_error_lastname == 1){ print(" is-invalid"); } ?> " id="nom" placeholder="Entrez votre nom" required>
                    <?php
                              if (isset($_SESSION['code_error_lastname']) && $_SESSION['code_error_lastname'] == 1){
                ...
                <div class="form-group">
                    ...
                    <input name="firstname" type="text" class="form-control <?php if ($code_error_firstname == 2){ print(" is-invalid"); } ?> " id="prenom" placeholder="Entrez votre prénom" required>
                    <?php

                                if (isset($_SESSION['code_error_firstname']) && $_SESSION['code_error_firstname'] == 2){
                ...
                <div class="form-group">
                    ...
                    <input name="address" type="text" class="form-control <?php if ($code_error_address == 3){ print(" is-invalid"); } ?> " id="adresse" placeholder="Nom, n° de rue" required>
                    <?php

                                if (isset($_SESSION['code_error_address']) && $_SESSION['code_error_address'] == 3){
                ...
                <div class="form-group">
                    ...
                    <input name="city" type="text" class="form-control <?php if ($code_error_city == 4){ print(" is-invalid"); } ?> " id="ville" placeholder="Ville" required>
                    <?php

                                if (isset($_SESSION['code_error_city']) && $_SESSION['code_error_city'] == 4){
                ...
                <div class="form-group">
                    ...
                    <input name="mail" type="mail" class="form-control <?php if ($code_error_mail == 5){ print(" is-invalid"); } ?> " id="mail" placeholder="exemple@exemple.fr" required>
                    <?php

                                if (isset($_SESSION['code_error_mail']) && $_SESSION['code_error_mail'] == 5){
                ...
                <div class="form-group">
                    ...
                    <input name="password" type="password" class="form-control <?php if ($code_error_password == 6){ print(" is-invalid"); } ?> " id="mdp" required>
                    <?php

                                if (isset($_SESSION['code_error_password']) && $_SESSION['code_error_password'] == 6){
                ...
                <div class="form-group">
                    ...
                    <input name="password_confirm" type="password" class="form-control <?php if ($code_error_password_confirm == 7){ print(" is-invalid"); } ?> " id="confirmation" required>
                    <?php

                                if (isset($_SESSION['code_error_password_confirm']) && $_SESSION['code_error_password_confirm'] == 7){
        ...
        <div id="connexion">
            ...
            <form action="login.php" method="post">
                ...
                <div class="form-group">
                    <label for="mail">E-mail:</label>
                    <input type="mail" class="form-control" id="mail" placeholder="exemple@exemple.fr" name="login_mail" required>
                    <?php

                                if (isset($_SESSION['code_error_login_mail']) && $_SESSION['code_error_login_mail']==1){
                                  $code_error_password_confirm = $_SESSION['code_error_login_mail'];
                                  print('
                                        <div class="alert alert-danger" role="alert">
                                            Adresse invalide !
                                        </div>
                ...
                <div class="form-group">
                    <label for="mdp">Mot de passe:</label>
                    <input type="password" class="form-control" id="mdp" name="login_password" required>
                    <?php

                            if (isset($_SESSION['code_error_login_password']) && $_SESSION['code_error_login_password']==1){
                                  $code_error_password_confirm = $_SESSION['code_error_password_confirm'];
                                print('
                                        <div class="alert alert-danger" role="alert">
                                            Mot de passe invalide !
